...
- **2026-05-10: REGRESSION DETECTED.** Signal: SIGNAL_REGRESSED. Issue was closed on May 9, 2026 but regressed on May 10, 2026 in version 2.9.4 (191). Impact: 3 events, 3 impacted users. Status reverted to `investigating`.
- 2026-05-10: Kanban task created: `t_83543ac5` (idempotency key: `crashlytics:8aeb52bf4fad6628513cae2330651dd6:regression`)
