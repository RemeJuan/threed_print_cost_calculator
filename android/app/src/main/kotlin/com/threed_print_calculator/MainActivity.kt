...
class MainActivity: FlutterFragmentActivity() {
    ...
    private val gcodePickerLauncher = registerForActivityResult(OpenDocument()) { uri ->
        ...
        runCatching {
            result.success(buildPickerPayload(uri))
        }.onFailure { error ->
    ...
    private fun copyUriToCache(uri: Uri, displayName: String): File {
        ...
        val prefix = sanitizedName.substringBeforeLast('.', sanitizedName).take(32).let {
