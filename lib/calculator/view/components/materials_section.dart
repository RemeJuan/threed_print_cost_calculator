    ...
    return Column(
      ...
      children: [
        FocusSafeTextField(
          ...
          keyboardType: TextInputType.number,
          decoration: InputDecoration(
            labelText: '${l10n.printWeightLabel} (${l10n.gramsSuffix})',
          ),
          onChanged: (value) {
            notifier
              ..updatePrintWeight(value)
        ...
        Row(
          children: [
            Text(l10n.materialsHeader, style: Theme.of(context).textTheme.titleMedium),
            const Spacer(),
            TextButton.icon(
        ...
        if (state.materialUsages.length == 1)
          Align(
            ...
            child: TextButton(
              ...
              child: Text(l10n.useSingleTotalWeightAction),
            ),
          ),
        if (state.materialUsages.isEmpty)
          Text(l10n.addAtLeastOneMaterial)
        else
        ...
        const SizedBox(height: 8),
        Text(l10n.totalMaterialWeightLabel(totalWeight)),
      ],
    );
  }
        ...
        return FractionallySizedBox(
          ...
          child: _MaterialPicker(
            onSelected: (material) {
              ...
              ref.read(calculatorProvider.notifier).addMaterialUsage(
                    MaterialUsageInput(
...
class _MaterialPicker extends HookWidget {
  const _MaterialPicker({required this.loadMaterials, required this.onSelected});
