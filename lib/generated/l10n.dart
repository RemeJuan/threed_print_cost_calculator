...
class S {
  ...
  String get calculatorNavLabel {
    return Intl.message('Calculator', name: 'calculatorNavLabel', desc: '', args: []);
  }
  ...
  String get settingsNavLabel {
    return Intl.message('Settings', name: 'settingsNavLabel', desc: '', args: []);
  }

  /// `Save Print`
  String get savePrintButton {
    return Intl.message('Save Print', name: 'savePrintButton', desc: '', args: []);
  }

  /// `Print Name`
  String get printNameHint {
    return Intl.message('Print Name', name: 'printNameHint', desc: '', args: []);
  }
  ...
  String get materialNameLabel {
    return Intl.message('Name *', name: 'materialNameLabel', desc: '', args: []);
  }
  ...
  String get deleteDialogTitle {
    return Intl.message('Delete', name: 'deleteDialogTitle', desc: '', args: []);
  }

  /// `Are you sure you want to delete this item?`
  String get deleteDialogContent {
    return Intl.message('Are you sure you want to delete this item?', name: 'deleteDialogContent', desc: '', args: []);
  }
  ...
  String get selectMaterialHint {
    return Intl.message('Select Material', name: 'selectMaterialHint', desc: '', args: []);
  }
  ...
  String get needHelpTitle {
    return Intl.message('Need Help?', name: 'needHelpTitle', desc: '', args: []);
  }

  /// `For any issues, please mail me at `
  String get supportEmailPrefix {
    return Intl.message('For any issues, please mail me at ', name: 'supportEmailPrefix', desc: '', args: []);
  }

  /// `google@remej.dev`
  String get supportEmail {
    return Intl.message('google@remej.dev', name: 'supportEmail', desc: '', args: []);
  }

  /// `Please include your Support ID: `
  String get supportIdLabel {
    return Intl.message('Please include your Support ID: ', name: 'supportIdLabel', desc: '', args: []);
  }

  /// `(click to copy) \n`
  String get clickToCopy {
    return Intl.message('(click to copy) \n', name: 'clickToCopy', desc: '', args: []);
  }

  /// `Support ID Copied`
  String get supportIdCopied {
    return Intl.message('Support ID Copied', name: 'supportIdCopied', desc: '', args: []);
  }

  /// `Privacy Policy`
  String get privacyPolicyLink {
    return Intl.message('Privacy Policy', name: 'privacyPolicyLink', desc: '', args: []);
  }

  /// `Terms of Use`
  String get termsOfUseLink {
    return Intl.message('Terms of Use', name: 'termsOfUseLink', desc: '', args: []);
  }
  ...
  String get mailClientError {
    return Intl.message('Could not open mail client', name: 'mailClientError', desc: '', args: []);
  }
  ...
  String get currentOfferings {
    return Intl.message('Current Offerings', name: 'currentOfferings', desc: '', args: []);
  }

  /// `There was an error processing your purchase. Please try again later.`
  String get purchaseError {
    return Intl.message('There was an error processing your purchase. Please try again later.', name: 'purchaseError', desc: '', args: []);
  }

  /// `Restore Purchases`
  String get restorePurchases {
    return Intl.message('Restore Purchases', name: 'restorePurchases', desc: '', args: []);
  }
  ...
  String get materialsHeader {
    return Intl.message('Materials', name: 'materialsHeader', desc: '', args: []);
  }

  /// `Electricity Cost: `
  String get electricityCostLabel {
    return Intl.message('Electricity Cost: ', name: 'electricityCostLabel', desc: '', args: []);
  }

  /// `Filament Cost: `
  String get filamentCostLabel {
    return Intl.message('Filament Cost: ', name: 'filamentCostLabel', desc: '', args: []);
  }

  /// `Labour Cost: `
  String get labourCostLabel {
    return Intl.message('Labour Cost: ', name: 'labourCostLabel', desc: '', args: []);
  }

  /// `Risk Cost: `
  String get riskCostLabel {
    return Intl.message('Risk Cost: ', name: 'riskCostLabel', desc: '', args: []);
  }

  /// `Total Cost: `
  String get totalCostLabel {
    return Intl.message('Total Cost: ', name: 'totalCostLabel', desc: '', args: []);
  }
}
