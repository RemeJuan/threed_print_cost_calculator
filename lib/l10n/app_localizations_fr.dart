...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get automaticBackupNote =>
      'Les sauvegardes automatiques s\'exécutent en arrière-plan lorsque votre appareil le permet. Le rythme choisi ne fait que rendre la sauvegarde à nouveau éligible ; le système d\'exploitation peut retarder l\'exécution réelle.';
  ...
  String automaticBackupStatusLabel(Object cadence, Object result) {
    return 'Sauvegarde automatique : $cadence • $result';
  }

  @override
  String automaticBackupExpectedRunWithDate(Object dateTime) {
    return 'Exécution prévue : à partir du $dateTime, quand votre appareil le permet.';
  }

  @override
  String get automaticBackupExpectedRunNoSuccess =>
      'Exécution prévue : quand votre appareil autorisera à nouveau le travail en arrière-plan.';
  ...
  String get playIntegrityActionBlocked =>
      'Cette action ne peut pas continuer sur cet appareil pour le moment. Réessayez plus tard ou utilisez un autre appareil.';
  ...
  String get batchItemLimitReachedMessage =>
      'Vous pouvez ajouter jusqu\'à 3 éléments de lot sur Free. Passez à Premium pour des éléments de lot illimités.';
  ...
  String get batchQuoteExportShareText =>
      'Export de devis par lot d\'impression 3D';
  ...
  @override
  String get materialsCsvExportTitle => 'Exporter les matériaux';

  @override
  String get materialsCsvExportShareText => 'Export CSV des matériaux';

  @override
  String get materialsCsvExportError => 'Impossible d\'exporter les matériaux.';
  ...
  String get csvImportIntro =>
      'Exportez vos matériaux actuels, modifiez le CSV, puis réimportez-le. Les lignes correspondantes sont mises à jour ; les nouveaux ID ou ID inconnus créent des matériaux locaux.';
  ...
  String get csvInvalidSpoolWeightError =>
      'Le poids de la bobine doit être un nombre valide.';

  @override
  String get csvInvalidRemainingWeightError =>
      'Le poids restant doit être un nombre valide et ne pas dépasser le poids de la bobine.';

  @override
  String get csvInvalidCostError => 'Le coût doit être un nombre valide.';

  @override
  String get csvInvalidTrackRemainingError =>
      'Le suivi restant doit être true ou false.';

  @override
  String get csvInvalidArchivedError => 'Archivé doit être true ou false.';

  @override
  String get csvInvalidHeaderError =>
      'L\'en-tête CSV ne correspond pas à l\'export des matériaux.';

  @override
  String get csvMalformedError => 'Le CSV contient des données mal formées.';
  ...
  String get csvImportQuotaExceededError =>
      'Cette importation dépasse votre limite de matériaux.';
  ...
  @override
  String get csvImportUpdatingStatus => 'Mettre à jour le matériau existant';

  @override
  String get csvImportCreatingStatus => 'Créer un matériau local';
  ...
  String csvImportApplyButton(int updates, int creates) {
    String _temp0 = intl.Intl.pluralLogic(
      creates,
      locale: localeName,
      other: 'Appliquer $updates mises à jour et créer $creates matériaux',
      one: 'Appliquer $updates mises à jour et créer 1 matériau',
      zero: 'Appliquer $updates mises à jour',
    );
    String _temp1 = intl.Intl.pluralLogic(
      creates,
      locale: localeName,
      other: 'Appliquer 1 mise à jour et créer $creates matériaux',
      one: 'Appliquer 1 mise à jour et créer 1 matériau',
      zero: 'Appliquer 1 mise à jour',
    );
    String _temp2 = intl.Intl.pluralLogic(
      creates,
      locale: localeName,
      other: 'Créer $creates matériaux',
      one: 'Créer 1 matériau',
    );
  ...
  @override
  String get csvImportReturnButton => 'Retour aux matériaux';
  ...
  String get batchCostingReviewEmptyBody =>
      'Ajoutez des impressions manuelles pour continuer.';
  ...
  String get batchGcodeImportDuplicateMessage =>
      'Certains fichiers ont déjà été ajoutés.';

  @override
  String get batchGcodeImportQuantityHint =>
      'Les quantités peuvent être ajustées à l’étape suivante.';
  ...
  String get paywallPitchLine =>
      'Matériaux illimités, imprimantes illimitées, export par lot, tarification avancée';

  @override
  String get paywallSubtitle =>
      'Débloquez toutes les fonctionnalités avec un achat unique ou un abonnement. Pas de compte, pas de suivi, uniquement vos données sur votre appareil.';
  ...
  @override
  String get paywallCta => 'Débloquez Premium';

  @override
  String get paywallRestore => 'Restaurer les achats';

  @override
  String get paywallRowPrintersLabel => 'Imprimantes';

  @override
  String get paywallRowMaterialsLabel => 'Matériaux';

  @override
  String get paywallRowHistoryLabel => 'Enregistrements d\'historique';

  @override
  String get paywallRowBatchCostingLabel => 'Calcul par lot';

  @override
  String get paywallRowAdvancedPricingLabel => 'Tarification avancée';

  @override
  String get paywallRowExportToolsLabel => 'Outils d\'export';

  @override
  String get paywallRowInventoryTrackingLabel => 'Suivi de l\'inventaire';

  @override
  String get paywallValueUnlimited => 'Illimité';

  @override
  String get paywallValueYes => 'Oui';

  @override
  String get paywallValueNo => 'Non';

  @override
  String get paywallValueBasic => 'Basique';

  @override
  String get paywallValueFull => 'Complet';

  @override
  String get paywallValueSingleJob => 'Travail unique';

  @override
  String get paywallValueFullSuite => 'Suite complète';

  @override
  String paywallValueUpToModels(Object limit) {
    return 'Jusqu\'à $limit modèles';
  }
  ...
  @override
  String get paywallPlanQuarterly => 'Trimestriel';
  ...
  @override
  String get paywallPlanTrial => 'Essai gratuit de 7 jours';

  @override
  String get paywallPlanCancelAnytime => 'Annulez à tout moment';

  @override
  String get paywallPlanOwnForever => 'Profitez de Premium pour toujours';

  @override
  String get paywallTrustLine => 'D\'abord hors ligne • Aucun compte requis';

  @override
  String get paywallCtaAnnualTrial => 'Commencer l\'essai gratuit de 7 jours';

  @override
  String paywallCtaQuarterly(Object price) {
    return 'Passer à la version supérieure pour $price';
  }

  @override
  String paywallCtaLifetime(Object price) {
    return 'Débloquez Premium pour $price';
  }
  ...
  String paywallValueSaves(Object limit) {
    return '$limit enregistrements';
  }

  @override
  String get paywallFeatureMaterialsTitle => 'Matériaux illimités';

  @override
  String get paywallFeatureMaterialsDesc =>
      'Enregistrez et gérez un nombre illimité de bobines de filament et de matériaux.';

  @override
  String get paywallFeaturePrintersTitle => 'Imprimantes illimitées';

  @override
  String get paywallFeaturePrintersDesc =>
      'Créez et gérez un nombre illimité de profils d\'imprimante.';

  @override
  String get paywallFeatureHistoryExportTitle => 'Export de l\'historique';

  @override
  String get paywallFeatureHistoryExportDesc =>
      'Exportez des entrées individuelles de l\'historique au format CSV.';

  @override
  String get paywallFeatureBulkHistoryExportTitle =>
      'Export groupé de l\'historique';

  @override
  String get paywallFeatureBulkHistoryExportDesc =>
      'Exportez tout l\'historique en une seule fois au format CSV.';

  @override
  String get paywallFeatureBatchGcodeImportTitle => 'Import de G-code par lot';

  @override
  String get paywallFeatureBatchGcodeImportDesc =>
      'Importez plusieurs fichiers G-code à la fois pour le calcul par lot.';

  @override
  String get paywallFeatureBatchExportTitle => 'Export par lot';

  @override
  String get paywallFeatureBatchExportDesc =>
      'Exportez des devis et des résumés par lot.';

  @override
  String get paywallFeatureLabourPricingTitle =>
      'Tarification de la main-d\'œuvre';

  @override
  String get paywallFeatureLabourPricingDesc =>
      'Ajoutez des tarifs horaires de main-d\'œuvre aux calculs de coûts.';

  @override
  String get paywallFeatureRiskPricingTitle => 'Tarification du risque';

  @override
  String get paywallFeatureRiskPricingDesc =>
      'Intégrez automatiquement le risque d\'échec dans la tarification.';

  @override
  String get paywallFeatureAdvancedPricingConfigTitle => 'Tarification avancée';

  @override
  String get paywallFeatureAdvancedPricingConfigDesc =>
      'Configurez la majoration, les frais de préparation et l\'arrondi.';

  @override
  String get paywallFeatureCsvMaterialImportTitle => 'Import de matériaux CSV';

  @override
  String get paywallFeatureCsvMaterialImportDesc =>
      'Importez des matériaux en lot à partir de fichiers CSV.';

  @override
  String get paywallFeatureStockTrackingTitle => 'Suivi du stock';

  @override
  String get paywallFeatureStockTrackingDesc =>
      'Suivez le stock de filament et recevez des alertes de stock faible.';
  ...
  String get paywallRestoreError =>
      'Échec de la restauration des achats. Veuillez réessayer plus tard.';

  @override
  String get paywallEmptyOfferings =>
      'Aucune formule d\'abonnement n\'est actuellement disponible. Veuillez réessayer plus tard.';

  @override
  String get helpSupportFaqPremiumQuestion =>
      'Qu\'est-ce que Premium apporte ?';

  @override
  String get helpSupportFaqPremiumAnswer =>
      'Free comprend tout le nécessaire pour calculer les coûts d\'impression, y compris l\'électricité, les impressions multi-matériaux, l\'importation G-code et le calcul par lot.\n\nPremium ajoute des outils de tarification avancés tels que la main-d\'œuvre, le risque d\'échec, la majoration, les frais de configuration, des analyses de coûts détaillées, un stockage de données illimité et le suivi des stocks de filament.';

  @override
  String get helpSupportFaqPremiumUpgradeCta => 'Passer à Premium';
  ...
  String get settingsPremiumCardBody =>
      'Outils de tarification avancés, utilisation illimitée et suivi des stocks.';

  @override
  String get settingsPremiumCardCta => 'Passer';

  @override
  String get calculatorPremiumFooterBody =>
      'Premium ajoute des outils de tarification avancés.';

  @override
  String get calculatorPremiumFooterCta => 'En savoir plus →';

  @override
  String automaticBackupLastSuccessWithDate(Object dateTime) {
    return 'Dernière sauvegarde réussie : $dateTime.';
  }

  @override
  String get automaticBackupLastSuccessNoBackup =>
      'Dernière sauvegarde réussie : pas encore.';
}
