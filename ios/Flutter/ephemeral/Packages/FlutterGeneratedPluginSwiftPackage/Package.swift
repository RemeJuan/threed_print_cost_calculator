...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "firebase_app_check", path: "../.packages/firebase_app_check-0.4.5"),
        ...
        .package(name: "purchases_flutter", path: "../.packages/purchases_flutter-10.3.0"),
        .package(name: "purchases_ui_flutter", path: "../.packages/purchases_ui_flutter-10.3.0"),
