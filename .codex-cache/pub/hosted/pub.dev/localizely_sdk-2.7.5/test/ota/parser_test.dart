...
import 'package:localizely_sdk/src/ota/parser/parser.dart';
import 'package:localizely_sdk/src/ota/parser/message_format.dart';
...
void main() {
  group('Literal messages', () {
    ...
    test('Test literal message with different tags', () {
      var response = IcuParser().parse(
        '<p>Literal <i>message</i> with a <br/> <b>tag</b>.</p><br>',
      );
    ...
    test('Test literal message with a complex json string', () {
      ...
      expect(
        response?.elementAt(5).value,
        equals(' "name": "programming" }, '),
      );
  ...
  group('Argument messages', () {
    ...
    test(
      ...
      () {
        var response = IcuParser().parse(
          'Link: https://example.com?user={username}&test=yes',
        );
    ...
    test(
      ...
      () {
        ...
        expect(
          response?.elementAt(0).value,
          equals('Argument message with <em>'),
        );
    ...
    test(
      ...
      () {
        ...
        expect(response?.elementAt(2).type, equals(ElementType.literal));
        expect(
          response?.elementAt(2).value,
          equals('</em> and <b>tag</b>!</p>'),
        );
      },
    );
    ...
    test(
      ...
      () {
        var response = IcuParser().parse(
          'Argument message with {placeholder} and < sign.',
        );
  ...
  group('Plural messages', () {
    ...
    test(
      'Test plural message with all plural forms when plural forms have tag',
      () {
        var response = IcuParser().parse(
  ...
  group('Gender messages', () {
    ...
    test(
      ...
      () {
        ...
        expect(
          genFemalePluOpt[1].value[0].runtimeType,
          equals(ArgumentElement),
        );
    ...
    test(
      'Test gender message with all gender forms when gender forms have tag',
      () {
        var response = IcuParser().parse(
    ...
    test(
      ...
      () {
        ...
        expect(options[0].value[0].type, equals(ElementType.literal));
        expect(
          options[0].value[0].value,
          equals('female message with < sign.'),
        );
  ...
  group('Select messages', () {
    ...
    test(
      'Test select message when there are no whitespace around select forms',
      () {
        var response = IcuParser().parse(
          '{choice,select,foo{This is foo option}bar{This is bar option}baz{This is baz option}}',
        );
